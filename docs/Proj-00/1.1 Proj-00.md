...
差点忘了，还有[补注](./1.2%20Notes.md)可以看！建议配合着一起食用。
...
![Install Step 3](./static/install_step_3.png)
...
有关`Black` `Pylint` `Mypy` `Flake8` `isort`的更多信息，参见[Proj-03的补注](../4%20Proj-03/4.3%20Notes.md)。
...
总之先创一个[**纯英文路径**](./1.2%20Notes.md#为什么路径要纯英文)的文件夹来当作项目文件夹罢。
